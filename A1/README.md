...
|-|-|-|
| Logout will invalidate the current session and redirect to the login page | R7.1 | Invalidate all the user sessions and redirect to the login page. |
| After logout, the user shouldn't be able to access restricted pages | R7.2 | Make sure that the restricted pages are inaccessible, and user should not be able to buy, sell or update tickets. |
|-|-|-|
| For any other requests, the system should return a 404 error | R8 | Make sure that invalid paths return 404. |
